...
function App() {
  ...
  function applyOcrFields(record, suggestions) {
    ...
    setProductForm(next); if (editingProductId) setProducts((prev)=>prev.map((p)=>p.id===editingProductId ? { ...p, ...next, updatedAt: now() } : p));
