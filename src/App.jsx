...
function App() {
  ...
  function reviewActiveDraft() { if (!activeDraft) return; setProductForm((p) => ({ ...p, ...activeDraft, userNotes: activeDraft.notes || p.userNotes, uploadedImages: activeDraft.uploadedImages || [] })); location.hash = 'scanner-manual-entry'; }
